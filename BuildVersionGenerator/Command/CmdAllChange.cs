...
{
    public class CmdAllChange : CmdBase
    {
        ...
        public override void Execute()
        {
            ...
            List<FileInfo> aryAllAssemblyInfoFiles = FindAllFiles(m_sSolutionPath, "AssemblyInfo.cs");
            List<FileInfo> aryAllProjectFiles = FindAllFiles(m_sSolutionPath, "*.csproj");
